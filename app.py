...
def _notify_intervention(iv_id, event_type, details="", extra_user_ids=None):
    ...
    try:
        ...
        # ═══ Format standardisé des notifications ═══
        # Ligne 1 (title) : Modification planning
        # Ligne 2 : Type (Bon maintenance / Bon dépannage)
        # Ligne 3 : N° projet · Nom projet
        # Ligne 4 : Date + horaires
        ...
        # Construction du body multi-lignes
        body_lines = [type_label]
...
def _notify_occupation(occ_id, event_type, details="", extra_user_ids=None, explicit_user_ids=None):
    ...
    try:
        ...
        # ═══ Format standardisé ═══
        # Ligne 1 (title) : Modification planning
        # Ligne 2 : Type d'occurrence
        # Ligne 3 : N° projet · Nom chantier
        # Ligne 4 : Date + horaires

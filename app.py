    ...
    try:
        ...
        for table in _MULTITENANT_TABLES:
            ...
            if _column_exists(db, table, "societe_id"):
                continue
            try:
                # SQLite ne supporte pas NOT NULL sans valeur sur ALTER TABLE pour
                # les tables non vides → on ajoute avec DEFAULT 1
                db.execute(f"ALTER TABLE {table} ADD COLUMN societe_id INTEGER NOT NULL DEFAULT 1 REFERENCES societes(id)")

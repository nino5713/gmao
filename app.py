...
def get_interventions():
    ...
    for r in result:
        ...
        # Pour les bons de dépannage : ajouter la liste des CRs (date, numéro, id) pour affichage planning
        if r.get("type") == "DEPANNAGE":
            try:
                r["comptes_rendus_light"] = rows(db.execute(

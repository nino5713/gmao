...
def generate_rapport(data):
    ...
    def _close_pair_into(real_story_target, sub_l, sub_r):
        ...
        # Largeur totale = 17cm (zone utile A4 avec marges 2cm). Chaque colonne = 8.5cm pile.
        # Les sub-stories utilisent _avail_w = 8.5cm pour remplir entièrement leur cellule.
        _half_w = 8.5*cm

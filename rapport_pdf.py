...
def generate_rapport(data):
    ...
    for _bidx, bloc in enumerate(mesures_techniques):
        ...
        # Pour 'graphique', 'preconisations', 'mesures_batteries' et 'image', les lignes ne sont pas affichées une à une
        if not lignes and bloc_type not in ('graphique', 'preconisations', 'mesures_batteries', 'image'):
            continue

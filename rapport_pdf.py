...
def generate_rapport(data):
    ...
    for _bidx, bloc in enumerate(mesures_techniques):
        ...
        if bloc_type == 'equipement':
            ...
            if _has_cellules:
                _cell_header = [
                    Paragraph(f'<font color="#fff" size="8"><b>DÉSIGNATION</b></font>', styles['Normal']),
                    Paragraph(f'<font color="#fff" size="8"><b>MARQUE</b></font>', styles['Normal']),
                    Paragraph(f'<font color="#fff" size="8"><b>TYPE</b></font>', styles['Normal']),
                ]
            ...
            if _has_tableaux:
                ...
                _tab_header = [
                    Paragraph(f'<font color="#fff" size="8"><b>NOM</b></font>', styles['Normal']),
                    Paragraph(f'<font color="#fff" size="8"><b>LOCALISATION</b></font>', styles['Normal']),
                ]

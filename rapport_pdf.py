        ...
        # ─── Type PRÉCONISATIONS : tableau des pièces de l'équipement avec préconisation calculée ───
            ...
            if not pieces:
                ...
                for idx, pc in enumerate(pieces):
                    ...
                    # Coloration de la cellule préconisation (col 4 maintenant)
                ...
                preco_table = Table(preco_data, colWidths=[
                    _avail_w * 0.18,  # Type
                    _avail_w * 0.20,  # Référence
                    _avail_w * 0.10,  # Nombre
                    _avail_w * 0.17,  # Installation
                    _avail_w * 0.35,  # Préconisation
                ])
                base_style_p = [

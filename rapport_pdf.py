...
def generate_rapport(data):
    ...
    if is_maintenance_layout:
        ...
        if has_gamme_ops_main:
            ...
            for g in gamme_ops_list_main:
                ...
                for op in ops:
                    ...
                    if done:
                        box = '<font name="Helvetica-Bold" size="10" color="#10B981">[X]</font>'
                        check_rows_main.append([
                            Paragraph(f'{box}&nbsp;&nbsp;{_xml_esc_main(desc)}', h_normal)
                        ])
                    else:
                        check_rows_main.append([
                            Paragraph(f'<font name="Helvetica" size="10" color="#94A3B8">[&nbsp;&nbsp;]</font>&nbsp;&nbsp;{_xml_esc_main(desc)}', h_normal)
                        ])
            if check_rows_main:
        ...
        # PAGE BREAK FORCÉ : équipement + descriptif + comptes-rendus + signatures sur pages suivantes
            ...
            for g in gamme_ops_list:
                ...
                for op in ops:
                    ...
                    if done:
                        ...
                        check_rows.append([
                            Paragraph(f'<font name="Helvetica" size="10" color="#94A3B8">[&nbsp;&nbsp;]</font>&nbsp;&nbsp;{_xml_esc_d(desc)}', h_normal)
                        ])
            if check_rows:

...
def generate_rapport(data):
    ...
    def _close_pair_into(real_story_target, sub_l, sub_r):
        ...
        # Largeur totale = 17cm (zone utile A4 avec marges 2cm). Chaque colonne = 8.5cm.
        # Le gap visuel entre les colonnes vient des paddings internes (3 par colonne = 6mm).
        _half_w = 8.5*cm
        ...
        _pair_table = Table(_pair_data, colWidths=[_half_w, _half_w], style=TableStyle([
            ('VALIGN', (0,0), (-1,-1), 'TOP'),
            # Petit padding gauche/droite pour créer un gap visuel entre les 2 colonnes
            ('LEFTPADDING', (0,0), (-1,-1), 0),
            ('RIGHTPADDING', (0,0), (0,-1), 4),  # padding droit sur la colonne gauche
            ('LEFTPADDING', (1,0), (1,-1), 4),   # padding gauche sur la colonne droite
            ('TOPPADDING', (0,0), (-1,-1), 0),
            ('BOTTOMPADDING', (0,0), (-1,-1), 0),
        ]))
